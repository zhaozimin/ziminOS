...
var SITES = [
  { label: "\u5B98\u7F51", cn: "https://zhaozimin.cn", com: "https://zhaozimin.com" },
  { label: "\u63D2\u4EF6\u6559\u7A0B", cn: "https://edu.zhaozimin.cn", com: "https://edu.zhaozimin.com" }
];
var SITES_HINT = ".cn \u90E8\u7F72\u5728\u4E2D\u56FD\u5927\u9646\uFF0C.com \u90E8\u7F72\u5728\u6D77\u5916\u2014\u2014\u54EA\u8FB9\u6253\u5F00\u5FEB\u5C31\u7528\u54EA\u8FB9\u3002";
var CHANNELS = [
  {
    name: "GitHub",
    label: "\u66F4\u591A\u5F00\u6E90\u5DE5\u5177",
    url: "https://github.com/zhaozimin",
  ...
  },
  {
    name: "X",
    label: "@ZiminZhao",
    url: "https://x.com/ZiminZhao",
    path: "M14.234 10.162 22.977 0h-2.072l-7.591 8.824L7.251 0H.258l9.168 13.343L.258 24H2.33l8.016-9.318L16.749 24h6.993zm-2.837 3.299-.929-1.329L3.076 1.56h3.182l5.965 8.532.929 1.329 7.754 11.09h-3.182z"
  },
  {
    name: "YouTube",
    label: "@ZiminZhao",
    url: "https://www.youtube.com/@ZiminZhao",
  ...
  },
  {
    name: "\u5C0F\u7EA2\u4E66",
    label: "\u5C0F\u7EA2\u4E66",
    url: "https://xhslink.cn/m/3NnLHIc6lQA",
...
function renderSiteLink(row, url, region) {
  row.createEl("a", { text: url.replace("https://", ""), href: url });
  row.appendText(`\uFF08${region}\uFF09`);
}
function renderChannel(row, channel) {
  const link = row.createEl("a", {
    cls: "ziminos-about-channel",
    href: channel.url,
    attr: { "aria-label": channel.name, title: channel.name, rel: "noopener" }
  });
  const icon = link.createSvg("svg", {
    cls: "ziminos-about-logo",
  ...
  link.appendText(channel.label);
}
function renderAboutPanel(el) {
  const panel = el.createDiv({ cls: "ziminos-about" });
  for (const site of SITES) {
    const row = panel.createDiv({ cls: "ziminos-about-site" });
    row.appendText(`${site.label}\u3000`);
    renderSiteLink(row, site.cn, "\u5927\u9646");
    row.appendText(" \xB7 ");
    renderSiteLink(row, site.com, "\u6D77\u5916");
  }
  panel.createDiv({ cls: "ziminos-about-hint", text: SITES_HINT });
  const channels = panel.createDiv({ cls: "ziminos-about-channels" });
  for (const channel of CHANNELS) renderChannel(channels, channel);
}
var aboutViews = [
  {
    name: ABOUT_VIEW,
