 ...
 *        版式（v0.9.3 定稿）：按地域切成上下两区，「海外」在上、「中国大陆」在下——
 *        分组本身就是「哪边快用哪边」的解释，解释性提示语因此退役。
 *        每区两枚站点磁贴（头像照片＝官网、星图＝插件教程，一枚磁贴一个域名，整贴可点）
 *        加一排频道胶囊（品牌原色图标 + 平台账号名）。
