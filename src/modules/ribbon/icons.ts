 ...
 * [OUTPUT]: 对外提供 registerZiminosIcons，把三十一个图形注册进 Obsidian 的图标库，
 ...
 *        三十一个图形出自同一套画法（Pikaicons：24 格、2 宽描边、圆头圆角），
