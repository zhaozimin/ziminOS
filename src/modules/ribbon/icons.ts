 ...
 * [OUTPUT]: 对外提供 registerZiminosIcons，把二十一个图形注册进 Obsidian 的图标库，
 ...
 *        二十一个图形出自同一套画法（Pikaicons：24 格、2 宽描边、圆头圆角），
 *        其中十六个是 Pikaicons 免费集里的原图（MIT，见 docs/第三方组件.md），
 *        五个是照同一套画法补画的——它们要么在免费集里没有（暂停、播放、灯泡、调色板），
 ...
 * 学员在外观面板里把图标调细，只有我们这二十一个不跟着变的话，那条边栏会一眼看出是外来户。
