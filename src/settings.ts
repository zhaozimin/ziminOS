 ...
 *        v0.17.0 把九张页各自的控件分走（给一页多一段，与骨架无关）。
 ...
 *        因此它归骨架而不归面板：落款的位置是全页面的承诺，不是某一页自己的事。
 *        V3 起页面按系统模块切成标签页（v0.17.0 起九张），切法不是新发明的分类，
 *        就是 modules/ 下的目录本身；边栏排在最末，因为它在 main.ts 里必须最后装配。
 *        开荒动作、微信读书扫码、三处重绘同步与作者名片都由 main 注入而非自己 import：
...
export class ZiminosSettingTab extends PluginSettingTab implements PanelHost {
    ...
    /** 九张页各自的控件。骨架不认识任何一页有什么，只认识「往这儿画」 */
